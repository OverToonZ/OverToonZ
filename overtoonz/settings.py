...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Ensure this matches your collectstatic target

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Add this if you have custom static files in your project
]
